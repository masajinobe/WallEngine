...
----------- 
Цель аппаратного ускорение, разгрузить процессор и переложить часть работы по видеообработке на видеокарту. По умолчанию включен режим hwdec=**auto**, который сам определяет наилучшую библиотеку для выполнения задач декодирования видео. Можно поставить библиотеку hwdec=**vdpau**, если вас не устаивает нагрузка на процессор у **auto**. Редактируется в **mpv.conf.**
...
**•Рекомендуется использовать видео в 30fps. 60fps чуть больше нагружают процессор и видеокарту.**
