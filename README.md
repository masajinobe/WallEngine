...
----------- 
Цель аппаратного ускорение, разгрузить процессор и переложить часть работы по видеообработке на видеокарту. По умолчанию включен режим hwdec=**auto**, который сам определяет наилучшую библиотеку для выполнения задач декодирования видео. Редактируется в **mpv.conf.**
